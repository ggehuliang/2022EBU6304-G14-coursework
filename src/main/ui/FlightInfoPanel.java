...
public class FlightInfoPanel extends BasePanel implements ActionListener {
    ...
    public void onCalled(JSONObject param) {
        ...
        if (BookingNum.equals("None") == false) {
            ...
            jb1.setText("<html>" + "BookingNum: " + "<br>" + Array.getJSONObject(0).getString("boookingNo") + "</html>");
            jb2.setText("<html>" + "BookingNum: " + "<br>" + Array.getJSONObject(1).getString("boookingNo") + "</html>");
            jb3.setText("<html>" + "BookingNum: " + "<br>" + Array.getJSONObject(2).getString("boookingNo") + "</html>");
            jb4.setText("<html>" + "BookingNum: " + "<br>" + Array.getJSONObject(2).getString("boookingNo") + "</html>");
            ...
            person = mainFrame.getDataService().getPersonById("114514");
            ...
            BookingNum = person.getJSONObject("checkinInfo").getString("bookingNo");

            jb1.setText("<html>" + BookingNum + "<br>" + SurName + "</html>");
            jl1.setText("Surname: " + SurName);
            jl2.setText("ID Num: " + IDNum);
            jl3.setText("Flight Num: " + FlightNum);
            jl4.setText("Departure Time: " + DepartureTime);
